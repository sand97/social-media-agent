...
export function AIAnalysisPanel({ suggestions, onApply, onDismiss }: AIAnalysisPanelProps) {
          ...
          <div className="flex items-start justify-between mb-2">
            <div className="flex-1">
              ...
              <div className="space-y-2">
                <div>
                  <span className="text-xs text-gray-500 uppercase">Actuel:</span>
                  <p className="text-sm text-gray-700 line-through">{suggestion.current}</p>
                </div>

                <div>
                  <span className="text-xs text-gray-500 uppercase">Suggestion:</span>
                  <p className="text-sm text-green-700 font-medium">{suggestion.suggested}</p>
                </div>

                <div>
                  <span className="text-xs text-gray-500 uppercase">Raison:</span>
